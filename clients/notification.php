						...
						<section class="panel panel-transparent">
							<div class="panel-body panel-transparent">
										...
										<table class="table table-striped table-bordered display example" width="100%">
											...
											<tbody>
												<?php
												$sql1="SELECT * FROM case_details WHERE client_key='$ses_ukey' AND case_date>='$cur_dte' AND case_date<='$afteddate' AND finact=0";
												...
												<?php
												$sql7="SELECT * FROM lawyerfeehistory_details INNER JOIN case_details ON lawyerfeehistory_details.casedetails_key=case_details.casedetail_key
												...
												while($row7=mysqli_fetch_array($result7)){
															...
															$result8 = mysqli_query($link,$sql2);
												...
												?>
													<tr>
														<td>
															Your lawyer charges is changed. New lawyer fee is Rs.<?php echo number_format($row7['fee'],2); ?>. Reason : <?php echo $row7['reasons']; ?>&nbsp;&nbsp; 
																Case Code : <?php echo $row7['case_code']; ?> &nbsp; 
																Case: <?php echo $case_name; ?> &nbsp; 
																Court: <?php echo $courtype_name." - ".$court_name; ?> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;   
																<?php echo $row7['date']; ?>&nbsp;&nbsp;&nbsp;&nbsp; 
																<a href="view_case.php?pcd=<?php echo $row7['casedetail_key'];?>" target="_blank"><button type="button" class="btn btn-success btn-sm">View Charges</button></a>
														</td>
													</tr>
												...
												<?php
												$sql12="SELECT *,casepayment_details.amount AS casepayamu FROM casepayment_details INNER JOIN case_details ON casepayment_details.casedetails_key=case_details.casedetail_key
												...
												?>	
													<tr>
														<td>
																Thank you for Your Payment. Payed amount : Rs.<?php echo number_format($row12['casepayamu'],2); ?>&nbsp;&nbsp; 
																Case Code : <?php echo $row12['case_code']; ?> &nbsp; 
																Case: <?php echo $case_name; ?> &nbsp; 
																Court: <?php echo $courtype_name." - ".$court_name; ?> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;   
																<?php echo $row12['datos']; ?>&nbsp;&nbsp;&nbsp;&nbsp; 
																<a href="view_case.php?pcd=<?php echo $row12['casedetail_key'];?>" target="_blank"><button type="button" class="btn btn-success btn-sm">View Payment</button></a>
														</td>
													</tr>
												<?php
												}
												...
												<?php
												$sql22="SELECT * FROM requestdocument_details INNER JOIN case_details ON requestdocument_details.casedetails_key=case_details.casedetail_key
																WHERE case_details.client_key='$ses_ukey' AND 
												...
												while($row22=mysqli_fetch_array($result22)){
															...
															$sql32="SELECT * FROM client_master WHERE client_key='$row22[client_key]' AND finact=0";
															$result32 = mysqli_query($link,$sql32);
															while($row32=mysqli_fetch_array($result32)){
																$e1=$row32['client_name'];
																$e7=$row32['email_address'];
																
															}
															
															$to=$e7;
															$subject='Case Management System - !Immidiate. 7 days only sumbmitting. You are request '.$row22['document_name'].'.';				//subject eka danna
															$msg1="Dear  ".$e1." \r\n"
																."!Immidiate. 7 days only sumbmitting. You are request ".$row22['document_name']." in submission before ".$row22['submission_date']." \r\n"
												...
												?>	
														<tr>
															<td>
																	!Immidiate. 7 days only sumbmitting. You are request <?php echo $row22['document_name']; ?> in submission before <?php echo $row22['submission_date']; ?>&nbsp;&nbsp; 
																	Case Code : <?php echo $row22['case_code']; ?> &nbsp; 
																	Case: <?php echo $case_name; ?> &nbsp; 
																	Court: <?php echo $courtype_name." - ".$court_name; ?> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;   
																	<?php echo $row22['submission_date']; ?>&nbsp;&nbsp;&nbsp;&nbsp; 
																	<a href="view_caseimg.php?re=<?php echo $row22['requestdoc_key'];?>" target="_blank"><button type="button" class="btn btn-success btn-sm">Upload</button></a>
															</td>
														</tr>
												<?php
												}
												...
												while($row27=mysqli_fetch_array($result27)){
															...
															$sql33="SELECT * FROM client_master WHERE client_key='$row27[client_key]' AND finact=0";
															$result33 = mysqli_query($link,$sql33);
															while($row33=mysqli_fetch_array($result33)){
																$e2=$row33['client_name'];
																$e3=$row33['email_address'];
																
															}
															
															$to=$e3;
															$subject='Case Management System - !Opps. Expire of Submitting Date. Immidiate Update Your document. You are request '.$row27['document_name'].'.';				//subject eka danna
															$msg1="Dear  ".$e2." \r\n"
																."!Opps. Expire of Submitting Date. Immidiate Update Your document. You are request ".$row27['document_name']." in submission before ".$row27['submission_date']." \r\n"
												...
												?>	
														<tr>
															<td>
																	!Opps. Expire of Submitting Date. Immidiate Update Your document. You are request <?php echo $row27['document_name']; ?> in submission before <?php echo $row27['submission_date']; ?>&nbsp;&nbsp; 
