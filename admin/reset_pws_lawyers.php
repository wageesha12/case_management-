...
<?php
	$sql1="SELECT * FROM lowyer_registration WHERE finact=0";
	$result1=mysqli_query($link,$sql1);
	$option1 ="";
	while($row1=mysqli_fetch_array($result1)){
		$option1 = $option1."<option>$row1[lowyer_name]</option>";
	}
	
	if(isset($_POST['btn_resetpw'])){
		$n1=$_POST['d2'];
		
		$sql2="SELECT * FROM lowyer_registration WHERE lowyer_name='$n1'";
		$result2=mysqli_query($link,$sql2);
		while($row2=mysqli_fetch_array($result2)){
			 	$ukeyo=$row2['lowyer_key'];
		}
		
		$pw=MD5(9900);
		$sql3="UPDATE lowyer_registration SET password ='$pw' WHERE lowyer_key='$ukeyo'";
						...
						<div class="panel-body">
							<form role="form" id="form1" name="form1" method="post" action="">
								...
								<div class="form-group" >
									<label class="fheader">Lawyer Name</label>
