						...
						$html ='<table border="0"  width="100%">
									<tr>
										<td width="100%" >
											...
											<div style="font-size:18px;font-weight:bold;" align="center">Prepair Points</div>
...
//$pdf->Image('images/image_demo.jpg', 90, 100, 60, 60, '', '', '', true, 72);
		...
		$html.='
			...
			<table border="0" width="100%">
				...
				$sql39="SELECT * FROM prepairpoints_details WHERE casecycle_key='$_GET[cy]' AND finact=0 ORDER BY paragraph ASC";
...
$pdf->Output('prepairpointreport_'.$t3.'_'.$g2.'.pdf', 'I');
