		...
		foreach($_FILES['upd_images']['name'] as $key=>$val){
            ...
            $fileType = pathinfo($target_file,PATHINFO_EXTENSION);
				...
				if (file_exists($target_new)) {
						...
						$to=$e7;
						$subject='Case Management System - You requested document is upload your Lawyer.';				//subject eka danna
						$msg1="Dear  ".$e1." \r\n"
									."You requested document is upload your Lawyer.	".$cur_dte." \r\n"
									."Your Case Code ".$t3." \r\n"
									."Case ".$b1." \r\n"
									."Court ".$c1." ".$d1." \r\n"
									."Thank You \r\n"
				...
				?>
						<form method="post" name="f5">
							<div class="col-md-4">
								<section class="panel panel-transparent">
									<div class="panel-body panel-transparent">
										<a href="requireddoc/<?php echo $row30['img_path'];?>" target="_blank">
										<img src="requireddoc/<?php echo $row30['img_path'] ?>" height="240px" width="100%" alt="">
										</a>
											<br>
											<br>
